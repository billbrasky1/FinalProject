...
public class FireBaseSignUp extends AppCompatActivity implements View.OnClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.fb_sign_up);
        ...
        if (firebaseAuth.getCurrentUser() != null) {
            ...
            startActivity(new Intent(getApplicationContext(), FireBaseLogoutActivity.class));
        }
                ...
                .addOnCompleteListener(this, new OnCompleteListener<AuthResult>() {
                    ...
                    public void onComplete(@NonNull Task<AuthResult> task) {
                        ...
                        if (task.isSuccessful()) {
                            ...
                            Toast.makeText(FireBaseSignUp.this, "Registration Error", Toast.LENGTH_LONG).show();
                        }
